[![Run App Connor Raatz](https://github.com/craatz8/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/craatz8/GithubActions/actions/workflows/run-app.yaml)
